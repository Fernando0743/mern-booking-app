...
import type { HotelSearchResponse, HotelType, UserType } from "../../backend/src/shared/types"
...
//Function that returns hotel given hotel ID
...
//Function that returns current logged user
